...
import com.msi.controller.DailyActiveUsersController;
...
public class AuthenticationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            boolean requiresPhone = beanType == MerchantController.class
                    || beanType == SupplyController.class
                    || beanType == TestPermissionController.class
                    || beanType == DailyActiveUsersController.class;
            ...
            boolean requiresMember = beanType == MerchantController.class
                    || beanType == SupplyController.class
                    || beanType == TestPermissionController.class;

            if (requiresMember && merchantService.isMemberExpired(merchant.getId())) {
