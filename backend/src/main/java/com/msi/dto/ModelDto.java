...
public class ModelDto {
    ...
    public ModelDto(Long model_id, String model_name, List<SpecDto> specArr) {
        this.model_id = model_id;
        this.model_name = model_name;
        this.specArr = specArr;
    }

    public ModelDto(Long brand_id, Long series_id, Long model_id, String model_name, List<SpecDto> specArr) {
    ...
    public List<SpecDto> getSpecArr() { return specArr; }
    public void setSpecArr(List<SpecDto> specArr) { this.specArr = specArr; }
}
