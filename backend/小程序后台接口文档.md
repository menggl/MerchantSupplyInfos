...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/all" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/brands" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/series/1" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/models/10" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/specs/100" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/cities" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/phone-remark" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/phone-model-remark" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/phone-model-version" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/phone-model-condition" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X GET "http://192.168.1.157:8083/api/dict/phone-model-maintenance" -H "Accept: application/json"
```
- 返回示例：
```json
[
...
- curl 示例：
```bash
curl -X POST "http://192.168.1.157:8083/api/wx-login" \
...
- curl 示例：
```bash
curl -X POST "http://192.168.1.157:8083/api/sms/send-code" \
  -H "Content-Type: application/json" \
...
- curl 示例：
```bash
curl -X PUT "http://192.168.1.157:8083/api/merchants/update" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer token_0001" \
  -d '{
    "merchantName": "张三通讯",
...
- curl 示例：
```bash
curl -X GET "http://localhost:8083/api/merchants/products/model?brandId=1&seriesId=10&modelId=100&specId=1000&productType=0" \
  -H "Authorization: Bearer token_0001"
```
- 返回示例：
```json
...
- curl 示例：
```bash
curl -X GET "http://localhost:8083/api/merchants/products/buy/model?brandId=1&seriesId=10&modelId=100&specId=1000&productType=0" \
  -H "Authorization: Bearer token_0001"
```
- 返回示例：
```json
...
- curl 示例：
```bash
curl -X POST "http://localhost:8083/api/merchants/merchant/sign-in" \
  -H "Authorization: Bearer token_0001"
```
